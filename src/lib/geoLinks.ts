/**
 * Geographic proximity linking engine for Gard (30).
...
export function getNearbyCommunes(
  ...
  return allCommunes
    ...
    .map(c => {
      ...
      // Approximate physical distance in km using local projection (43.83°N for Nîmes/Gard)
      // 1 degree of Latitude ≈ 111.1 km
      // 1 degree of Longitude ≈ 111.1 * cos(43.83°) ≈ 80.1 km
      const dLat = (lat - currentLat) * 111.1;
      const dLon = (lon - currentLon) * 80.1;
